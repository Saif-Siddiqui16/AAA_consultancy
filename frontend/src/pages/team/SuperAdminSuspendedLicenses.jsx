...
export const SuperAdminSuspendedLicenses = () => {
  ...
  const handleOpenEditModal = (agency) => {
    ...
    setIsPaid(agency.isPaid !== undefined ? agency.isPaid : false);
  ...
  const suspendedAgencies = agencies.filter(a => a.isPaid === false);

  return (
    <Box sx={{ pb: 4 }}>
      <PageHeader
        title="Suspended & Unpaid Licenses"
        subtitle="Directory of unpaid or temporarily locked partner agency workspaces."
        action={
          <Button
            variant="contained"
            color="secondary"
              ...
              {suspendedAgencies.length === 0 && (
                <TableRow>
                  <TableCell colSpan={7} align="center" sx={{ py: 6, color: 'text.secondary' }}>
                    No suspended/unpaid licenses found.
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
...
export default SuperAdminSuspendedLicenses;
