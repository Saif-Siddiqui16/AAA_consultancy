...
export const AdminDashboard = () => {
  ...
  // Outstanding Revenue: sum of all pending payment amounts
  const outstandingRevenue = payments
    .filter((p) => p.status === 'Pending')
    .reduce((sum, p) => sum + (p.amount || p.totalPaid || 0), 0);

  // Refunded: payments that are Refunded
  ...
  const statsList = [
    { title: 'Total Clients', value: clients.length, icon: <PeopleAltIcon />, color: '#3F51B5', trend: '12%', onClick: () => navigate('/admin/clients', { state: { filterStatus: '', cardInfo: { title: 'Total Clients', value: clients.length, color: '#3F51B5', trend: '12%', iconType: 'PeopleAlt' } } }) },
    { title: "Today's Clients", value: clientsTodayCount, icon: <AddIcon />, color: '#14B8A6', trend: '24%', onClick: () => navigate('/admin/clients', { state: { filterStatus: '', cardInfo: { title: "Today's Clients", value: clientsTodayCount, color: '#14B8A6', trend: '24%', iconType: 'Add' } } }) },
    { title: 'Total Consultations', value: totalLeads, icon: <PeopleAltIcon />, color: '#8B5CF6', trend: '12%', onClick: () => navigate('/admin/leads', { state: { filterToday: false, filterStatus: '', cardInfo: { title: 'Total Consultations', value: totalLeads, color: '#8B5CF6', trend: '12%', iconType: 'PeopleAlt' } } }) },
    { title: "Today's Consultations", value: todayLeadsCount, icon: <AddIcon />, color: '#EC4899', trend: '24%', onClick: () => navigate('/admin/leads', { state: { filterToday: true, filterStatus: '', cardInfo: { title: "Today's Consultations", value: todayLeadsCount, color: '#EC4899', trend: '24%', iconType: 'Add' } } }) },
    { title: 'Upcoming Meetings', value: upcomingMeetingsCount, icon: <CalendarMonthIcon />, color: '#2563EB', trend: '8%', onClick: () => navigate('/admin/consultations', { state: { filterStatus: 'Scheduled', cardInfo: { title: 'Upcoming Meetings', value: upcomingMeetingsCount, color: '#2563EB', trend: '8%', iconType: 'CalendarMonth' } } }) },
    { title: 'Pending Payments', value: pendingPaymentsCount, icon: <PaymentsIcon />, color: '#F59E0B', trend: '-5%', onClick: () => navigate('/payments/invoices', { state: { filterStatus: 'Pending', cardInfo: { title: 'Pending Payments', value: pendingPaymentsCount, color: '#F59E0B', trend: '-5%', iconType: 'Payments' } } }) },
    { title: 'Total Revenue', value: `€${revenueTotal.toLocaleString()}`, icon: <TrendingUpIcon />, color: '#22C55E', trend: '18%', onClick: () => navigate('/payments/invoices', { state: { filterStatus: 'Paid', cardInfo: { title: 'Total Revenue', value: `€${revenueTotal.toLocaleString()}`, color: '#22C55E', trend: '18%', iconType: 'TrendingUp' } } }) },
    { title: 'Active Cases', value: activeCasesCount, icon: <AssignmentIcon />, color: '#3B82F6', trend: '14%', onClick: () => navigate('/admin/clients', { state: { filterStatus: 'Under Process', cardInfo: { title: 'Active Cases', value: activeCasesCount, color: '#3B82F6', trend: '14%', iconType: 'Assignment' } } }) },
    { title: 'Completed Cases', value: completedCasesCount, icon: <CheckCircleOutlinedIcon />, color: '#10B981', trend: '20%', onClick: () => navigate('/admin/clients', { state: { filterStatus: 'Completed', cardInfo: { title: 'Completed Cases', value: completedCasesCount, color: '#10B981', trend: '20%', iconType: 'CheckCircleOutlined' } } }) },
    { title: 'Lost Consultations', value: lostLeadsCount, icon: <WarningAmberIcon />, color: '#EF4444', trend: '2%', onClick: () => navigate('/admin/leads', { state: { filterStatus: 'Lost Lead', filterToday: false, cardInfo: { title: 'Lost Consultations', value: lostLeadsCount, color: '#EF4444', trend: '2%', iconType: 'WarningAmber' } } }) },
    { title: 'Revenue Today', value: `€${revenueTodayTotal.toLocaleString()}`, icon: <TrendingUpIcon />, color: '#14B8A6', trend: '8%', onClick: () => navigate('/payments/invoices', { state: { filterStatus: 'Paid', cardInfo: { title: 'Revenue Today', value: `€${revenueTodayTotal.toLocaleString()}`, color: '#14B8A6', trend: '8%', iconType: 'TrendingUp' } } }) },
    { title: 'Outstanding Revenue', value: `€${outstandingRevenue.toLocaleString()}`, icon: <AccountBalanceWalletIcon />, color: '#F59E0B', trend: '-2%', onClick: () => navigate('/payments/invoices', { state: { filterStatus: 'Pending', cardInfo: { title: 'Outstanding Revenue', value: `€${outstandingRevenue.toLocaleString()}`, color: '#F59E0B', trend: '-2%', iconType: 'AccountBalanceWallet' } } }) },
    { title: 'Refunded (50% Rejections)', value: `€${refundedTotal.toLocaleString()}`, icon: <CancelIcon />, color: '#EF4444', trend: '4%', onClick: () => navigate('/payments/invoices', { state: { cardInfo: { title: 'Refunded (50% Rejections)', value: `€${refundedTotal.toLocaleString()}`, color: '#EF4444', trend: '4%', iconType: 'Cancel' } } }) },
  ];
